    ...
    <section class="section-networks" id="networks">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8 text-center">
          <img src="{{url('frontend/images/partner.png')}}" alt="logo partner" class="img-partner" alt="" /></div>
        </div>
      </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="section-popular-content row justify-content-center">
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card card-testimonial text-center">
              <div class="testimonial-content">
                ...
                <h3 class="mb-4">Raka Adli</h3>
                <p class="testimonial">
                  "It was glorius day of my life travel with snap!"
                </p>
              </div>
              <hr />
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card card-testimonial text-center">
              <div class="testimonial-content">
                ...
                <h3 class="mb-4">Mbak Elizabeth</h3>
                <p class="testimonial">
                  "The best trip i have ever been!!!!!!"
                </p>
              </div>
              <hr />
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card card-testimonial text-center">
              <div class="testimonial-content">
                <img src="frontend/images/avatar-5@2X.png" alt="User" class="mb-4 rounded-circle" />
                <h3 class="mb-4">Mas Pratama</h3>
                <p class="testimonial">
                  "Cheap price great moments!!!"
                </p>
              </div>
              <hr />
              <p class="trip-to mt-2">Trip to ubud</p>
