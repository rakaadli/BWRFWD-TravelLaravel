                ...
                <div class="row">
                        ...
                        <div class="card card-details">
                                    ...
                                    <tbody>
                                        ...
                                        <td><img src="https://ui-avatars.com/api/?name={{$detail->username}}" height="60" class="rounded-circle"></td>
                                            ...
                                            <td class="align-middle"><a href="{{route('checkout-remove', $detail->id)}}"><img
                                                        src="{{url('frontend/images/ic_remove.png')}}"></a></td>
                                        </tr>
                                        @empty
                                            <tr>
                                                <td colspan="6" class="text-center">
                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline" method="post" action={{route('checkout-create', $item->id)}}>
                                    ...
                                    <input required type="text" name="nationality" class="form-control mb-2 mr-sm-2" style="width:50px"
                                ...
                                <h3 class="mt-2 mb-0">Note</h3>
                                <p class="dislaimer mb-0">
                                    You are only invite member that has registered in Snaptravel
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 pl-lg-0">
                        <div class="card card-details card-right">
                            ...
                            <h2>Payment Instructions</h2>
                            <p class="payment-instructions">
                                please complete your payment before to <br /> continue for wonderful trip
                            </p>
                            <div class="bank">
                                <div class="bank-item pb-3">
                                    <img src="{{url('frontend/images/ic_bank.png')}}" alt="" class="bank-image" />
                                    <div class="description">
                                        <h3>PT SNAPTRAVEL ID</h3>
                                        <p>2302384593<br />
                                            BANK CENTRAL ASIA
                                        </p>
                                    </div>
