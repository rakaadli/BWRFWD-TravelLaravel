                ...
                <div class="col-lg-4 pl-lg-0">
                    <div class="card card-details card-right">
                        ...
                        <div class="members my-2">
                            <img src="/frontend/images/members.png" class="member-image"></img>
                        </div>
                        <hr />
                        ...
                        <table class="trip-informations">
                            <tr>
                                ...
                                <td width=50% class="text-right">{{ \Carbon\Carbon::create($item->date_of_departure)->format('F n, V')}}</td>
                            </tr>
                            <tr>
